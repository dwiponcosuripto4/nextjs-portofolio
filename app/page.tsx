      ...
      <div className="container mx-auto min-h-screen px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-2 sm:gap-4 lg:grid-cols-12 lg:gap-0">
          <div className="relative h-[48vh] touch-none sm:h-[46vh] lg:col-span-6 lg:h-screen">
            <Lanyard position={[0, 0, 12]} gravity={[0, -70, 0]} />
          </div>
              ...
              <div className="flex flex-col gap-4 sm:gap-6">
                ...
                <div className="flex flex-col items-start">
                  <SplitText
                    ...
                    className="text-start text-3xl font-semibold sm:text-4xl md:text-5xl lg:text-6xl"
                    delay={50}
                    animationFrom={{
                      opacity: 0,
                  ...
                  <SplitText
                    ...
                    className="text-start text-3xl font-semibold text-[#3FA9C9] sm:text-4xl md:text-5xl lg:text-6xl"
                    delay={75}
                    animationFrom={{
                      opacity: 0,
                      transform: "translate3d(0,50px,0)",
