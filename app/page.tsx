          ...
          <div className="lg:col-span-6">
            <div className="flex items-center h-full py-8 lg:py-0">
              <div className="flex flex-col gap-4 sm:gap-6">
                ...
                <BlurText
                  text="I am a fresh graduate from Universitas Muhammadiyah Yogyakarta, majoring in Information Technology, with an interest in front-end and back-end web development. I have experience working on academic projects involving system analysis, UI design, and web development, and I am eager to learn and grow professionally."
                  delay={75}
                  animateBy="words"
                  direction="top"
